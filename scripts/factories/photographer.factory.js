...
function photographerFactory(data) {
    ...
    function homePageCard() {
        ...
        const params = {
            ...
            options: {
                cardLink: {
                    href: { query: { userId: id } },
                    page: 'oc-p6-fisheye/photographer.html',
                },
            },
        }

        const { cardPicture, cardLink, cardTitle, cardLocation, cardDescription, cardPrice } =
            photographerElements(params)
    ...
    function photographerPageCard() {
        ...
        const {
            cardPicture: photographerPicture,
            cardTitle,
            cardLocation,
            cardDescription,
        } = photographerElements(params)
